...
import { toaster, DtableIconButton } from 'dtable-ui-component';
      ...
      <div className="plugin-map-dialog-en" style={this.getDialogStyle()}>
        <div className={'dtable-map-plugin-title'}>
          ...
          <div className="map-operators">
            <DtableIconButton
              symbol='dtable-icon-download'
              tooltip={intl.get('Download')}
              aria-label={intl.get('Download')}
              onClick={onCapture}
              className="btn-margin-right"
            />
            <DtableIconButton
              symbol='dtable-icon-full-screen'
              tooltip={intl.get('Full_screen')}
              aria-label={intl.get('Full_screen')}
              onClick={this.toggleFullScreen}
              className={`btn-margin-right  ${isFullScreen ? 'full-screen-active' : ''}`}
            />
            <DtableIconButton
              symbol='dtable-icon-set-up'
              tooltip={intl.get('Settings')}
